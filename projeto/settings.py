...
SECRET_KEY = 'django-insecure-ebbnl5h(@ooy(lxwes*&pv0!ye1mt*g653fi8m2fd@j#%w@+#h'
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "Gestão RFID",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "Gestão RFID",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "Gestão RFID",
    ...
    "welcome_sign": "Bem vindo ao Gestão RFID",

    # Copyright on the footer
    "copyright": "Raphael Costa",
    ...
    "topmenu_links": [
        ...
        {"name": "Site", "url": "http://34.233.165.73/", "new_window": True},

        # external url that opens in a new window (Permissions can be added)
        {"name": "Suporte", "url": "https://www.google.com.br/?hl=pt-BR", "new_window": True},
